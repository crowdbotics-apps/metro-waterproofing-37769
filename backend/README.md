...
## Project Structure
    ...
    ├── metro_waterproofing_37769  # Django project configurations
...
1. Clone this repo and `cd metro_waterproofing_37769`
...
2. Clone this repo and `cd metro_waterproofing_37769`
